...
<ul>
  ...
  <li>Classificação automática (Bom, Médio, Ruim)</li>
...
<p>Percentual de pedidos não atendidos.</p><h2>🛠️ Tecnologias</h2>
<ul>
  <li>HTML5</li>
  <li>CSS3</li>
  <li>JavaScript</li>
...
<ol>
  <li>Acesse o sistema:
    <br>
    https://kccristinadev-dev.github.io/Calculadora-de-Indicadores-2.0/
  </li>
  <li>Cadastre um produto preenchendo os campos</li>
